...
if cylinder then
  ...
  KIKS_ARENA_MASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx)) = mtlb_a(mtlb_double(KIKS_ARENA_MASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx))),mtlb_double(mtlb(KIKS_OBJECT_SMALLBALL_MA)));
  // ! L.21: mtlb(KIKS_OBJECT_SMALLBALL_MA) can be replaced by KIKS_OBJECT_SMALLBALL_MA() or KIKS_OBJECT_SMALLBALL_MA whether KIKS_OBJECT_SMALLBALL_MA is an M-file or not
  KIKS_ARENA_COLORMASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx)) = mtlb_a(mtlb_double(KIKS_ARENA_COLORMASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx))),mtlb_double(mtlb(KIKS_OBJECT_SMALLBALL_MA)));
else
  KIKS_ARENA_MASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx)) = mtlb_a(mtlb_double(KIKS_ARENA_MASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx))),mtlb_double(KIKS_OBJECT_BALL_MASK));
  // ! L.24: mtlb(KIKS_OBJECT_BALL_MASK_CO) can be replaced by KIKS_OBJECT_BALL_MASK_CO() or KIKS_OBJECT_BALL_MASK_CO whether KIKS_OBJECT_BALL_MASK_CO is an M-file or not
  KIKS_ARENA_COLORMASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx)) = mtlb_a(mtlb_double(KIKS_ARENA_COLORMASK(mtlb_imp(miny,maxy),mtlb_imp(minx,maxx))),mtlb_double(mtlb(KIKS_OBJECT_BALL_MASK_CO)));
end;
endfunction
